...
<p style="color:#08519c">*A continuación se detallan las alertas para cada posición, punta (compradora y vendedora) y producto. La alerta se emite cuando se detecta que el rango de variación es mayor a un porcentaje del precio medio de ese día. El rango de variación se determina como la diferencia entre el precio máximo y mínimo informados para esa posición, punta y producto en cada día. *</p>
<p style="color:#08519c">*Los rangos de variación con que se disparan las alertas son:*</p>
<p style="color:#08519c">*Soja(c/bu)  4.5%*</p>
<p style="color:#08519c">*Aceite de Soja(c/lib) 4%*</p>
<p style="color:#08519c">*Harina de Soja(usd/ton) 3.5%*</p>
<p style="color:#08519c">*Maíz(c/bu) 9%*</p>
<p style="color:#08519c">*Trigo(Flat) 14%*</p>
<p style="color:#08519c">*Aceite de Girasol(Flat) 10%*</p>
